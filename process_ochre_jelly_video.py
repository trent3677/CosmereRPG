...
def main():
    """Process the ochre jelly video"""
    
    print("="*60)
    print("OCHRE JELLY VIDEO PROCESSOR")
    print("="*60)
    ...
    # Input file - try both possible names
    input_video = None
    possible_names = ["ochre_jelly.mp4", "ochre_jelly_animation.mp4", "ochrejelly.mp4"]
    ...
    if not input_video:
        print(f"\n✗ ERROR: No ochre jelly video found!")
        print("Looked for: " + ", ".join(possible_names))
    ...
    print("\nNote: Ochre Jelly is not from Thornwood Watch, but it's")
    print("a cool ooze monster that can be used in any module!")
