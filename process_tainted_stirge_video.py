...
def main():
    """Process the tainted stirge video"""
    
    print("="*60)
    print("TAINTED STIRGE VIDEO PROCESSOR")
    print("="*60)
    ...
    # Input file
    input_video = "tainted_stirge_animation.mp4"
